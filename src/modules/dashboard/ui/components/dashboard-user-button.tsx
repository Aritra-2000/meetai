        ...
        return(
            <Drawer>
                ...
                <div className="flex flex-col gap-0.5 text-left overflow-hidden flex-1 min-w-0">
                    <p className="text-sm tranculate w-full">
                        {data.user.name}
                    </p>
                    <p className="text-xs tranculate w-full">
                        {data.user.email}
                    </p>
                </div>
                ...
                <DropdownMenuContent align="end" side="right" className="w-72">
                    <DropdownMenuLabel>
                        <div className="flex flex-col gap-1">
                            <span className="font-medium tranculate">{data.user.name}</span>
                            <span className="text-sm font-normal text-muted-foreground tranculate">{data.user.email}</span>
                        </div>
                    </DropdownMenuLabel>
                    <DropdownMenuSeparator/>
                    <DropdownMenuItem
